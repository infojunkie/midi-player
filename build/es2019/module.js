...
const createMidiPlayer = createMidiPlayerFactory(createMidiFileSlicer, createStartIntervalScheduler(clearInterval, performance, setInterval), createStartTimeoutScheduler(clearTimeout, setTimeout));
